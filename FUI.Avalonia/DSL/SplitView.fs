...
type SplitViewBuilder<'t when 't :> SplitView and 't : equality>() = 
    ...
    member _.compactPaneLengthProperty<'t, 'v>(x, value: float) =
    ...
    member _.paneBackground<'t, 'v>(x, value: 'v) =
    ...
    member _.templateSettings<'t, 'v>(x, value: 'v) =
