...
type ThumbBuilder<'t when 't :> Thumb and 't : equality>() =
    ...
    member _.onDragStarted<'t, 'v>(x: Types.AvaloniaNode<'t>, func: VectorEventArgs -> unit) =
        Types.routedEvent x Thumb.DragStartedEvent func
        
    [<CustomOperation("onDragDelta")>]
    member _.onDragDelta<'t, 'v>(x: Types.AvaloniaNode<'t>, func: VectorEventArgs -> unit) =
        Types.routedEvent x Thumb.DragDeltaEvent func
        
    [<CustomOperation("onDragCompleted")>]
    member _.onDragCompleted<'t, 'v>(x: Types.AvaloniaNode<'t>, func: VectorEventArgs -> unit) =
