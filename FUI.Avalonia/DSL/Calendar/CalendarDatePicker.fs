...
type CalendarDatePickerBuilder<'t when 't :> CalendarDatePicker and 't : equality>() =
    inherit TemplatedControlBuilder<'t>()
     ...
     member _.displayDate<'t, 'v>(x, value: 'v) =
     ...
     member _.onDropDownOpenChanged<'t>(x, func: bool -> unit) =
     ...
     member _.selectedDateFormat<'t, 'v>(x, value: 'v) =
     ...
     member _.customDateFormatString<'t, 'v>(x, value: 'v) =
