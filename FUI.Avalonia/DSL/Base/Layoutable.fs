...
type LayoutableBuilder<'t when 't :> Layoutable and 't : equality>() =
    ...
    member _.horizontalAlignment<'t, 'v>(x: Types.AvaloniaNode<'t>, value: 'v) =
    ...
    member _.verticalAlignment<'t, 'v>(x: Types.AvaloniaNode<'t>, value: 'v) =
        Types.dependencyProperty x Layoutable.VerticalAlignmentProperty value
       
    /// bool | ObservableValue<bool>
    [<CustomOperation("useLayoutRounding")>]
    member _.useLayoutRounding<'t, 'v>(x: Types.AvaloniaNode<'t>, value: 'v) =
