...
type ComboBoxBuilder<'t when 't :> ComboBox and 't : equality>() =
    ...
    member _.selectionBoxItemProperty<'t, 'v>(x, value: 'v) =
    ...
    member _.placeholderForeground<'t, 'v>(x, value: 'v) =
