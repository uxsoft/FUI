...
type ShapeBuilder<'t when 't :> Shape and 't : equality>() =
    ...
    member _.fill<'t, 'v>(x: Types.AvaloniaNode<'t>, brush: 'v) =
    ...
    member _.strokeDashArray<'t, 'v>(x: Types.AvaloniaNode<'t>, value: AvaloniaList<double>) =
        Types.dependencyProperty x Shape.StrokeDashArrayProperty value
        
    /// double | ObservableValue<double>
    [<CustomOperation("strokeDashOffset")>] 
    member _.strokeDashOffset<'t, 'v>(x: Types.AvaloniaNode<'t>, value: 'v) =
    ...
    member _.strokeLineCap<'t, 'v>(x: Types.AvaloniaNode<'t>, value: 'v) =
    ...
    member _.strokeJoinCap<'t, 'v>(x: Types.AvaloniaNode<'t>, value: 'v) =
